...
// Ambil data rm
$sql = "SELECT * FROM rm WHERE status = 'MUSNAH' AND tanggal_status BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal_status ASC";
...
if ($result && $result->num_rows > 0) {
    ...
    $mpdf->SetTitle('Laporan Pemusnahan Rekam Medis');
